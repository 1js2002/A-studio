  ...
  return (
    <div className="relative w-full flex md:flex-row flex-col py-6">
      <div className="md:w-1/2 md:ml-[140px] md:mt-36">
        <h1 className="text-center font-averta-demo-pe-cutted-demo text-4xl font-bold md:text-left md:flex justify-start my-3 ">
          A Digital Product Agency
        </h1>
        <p className="text-center text-gray-600 md:text-left  md:flex justify-start my-3">
        ...
        <div className="flex items-center justify-center md:justify-start  md:my-4">
          <button className="bg-[#2639ED] w-52 h-20 font-semibold text-xl text-white rounded-[60px] my-6 hover:bg-blue-800">
            Contact Now
          </button>
        </div>
      </div>
      ...
      <div className="hidden lg:block absolute z-[-10] right-[45.5%] flex-shrink-0 md:flex-shrink">
        <svg
          className="w-129 md:w-129 md:h-129"
          width="129"
          height="129"
          viewBox="0 0 129 129"
          fill="none"
      ...
      <div className="hidden lg:block absolute z-[-10] -bottom-20 right-32 flex-shrink-0 md:flex-shrink">
        <svg
          width="178"
          height="178"
          viewBox="0 0 178 178"

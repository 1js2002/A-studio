...
const Subscribe = () => {
  return (
    <div className="relative md:h-[45%] h-[30%] md:mx-40 my-20">
        <div className="flex flex-col md:flex-row md:w-full relative">
            ...
            <div className='absolute -z-20 -top-10 '>
              <svg width="1197" height="292" viewBox="0 0 1197 292" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="1197" height="292" rx="75" fill="#F4F9FF"/>
                </svg>
            </div>
            <div className='absolute -z-20 -top-10 right-0 md:block hidden '>
              <svg width="497" height="292" viewBox="0 0 497 292" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='absolute -z-30 -top-24 -right-10 md:block hidden '>
    ...
    <circle cx="171.5" cy="150.5" r="3.5" fill="#DFEEFF"/>
            ...
            <div className='absolute -z-30 top-32 -left-10 md:block hidden '>
              <svg width="178" height="178" viewBox="0 0 178 178" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M178 0L178 178L100 178C44.7715 178 1.58873e-06 133.228 9.30141e-07 78L0 2.12263e-06L178 0Z" fill="#FFF5DB"/>
              </svg>
            </div>
        </div>
    </div>

...
const HappyClient = () => {
  return (
    <div className='min-h-screen w-full flex flex-col'>
      <div>
        {/* heading */}
        <h1 className='text-4xl font-semibold text-center py-5'>What our Happy Clients Say</h1>
        <p className='text-gray-600 text-center'>Several selected clients, who already believe in our service.</p>
      </div>
      <div className='md:flex md:flex-row md:mt-16'>
        <div className='relative md:w-1/3 flex items-center justify-start md:ml-16'>
        <div className='absolute -z-10 left-8 bottom-16 '> {/*circle */}
